...
QWEN3_CUDNN_BENCHMARK = os.getenv("QWEN3_CUDNN_BENCHMARK", "1") == "1"
QWEN3_ALLOW_TF32 = os.getenv("QWEN3_ALLOW_TF32", "1") == "1"
QWEN3_MATMUL_PRECISION = os.getenv("QWEN3_MATMUL_PRECISION", "high")
